...
BOUNDARY CONDITION — D3 External Review: The following do NOT constitute external
review for the purposes of this criterion and must be rated Not met: regulatory
approval processes (e.g., NHMRC section 14A approval, TGA approval), journal peer
review, endorsement by a professional body, and government agency sign-off. External
review requires a structured, pre-publication consultation with independent clinical
or methodological experts that is separate from the guideline development group, with
documented reviewer comments and a description of how those comments were addressed.
If the guideline only evidences regulatory approval or journal publication as external
scrutiny, all five external review criteria must be rated Not met and the item scored 1.
